...
async function friendlyStart() {
    ...
    try {
        ...
        alert("PERMISSION_REQUIRED: Local environment requires a Secure connection. Please click 'Allow' for the camera/microphone configuration.");
        return;
    }
...
/**
 * Configures and displays the secure external encrypted Jitsi command module
 */
function initJitsi() {
    const domain = "8x8.vc";
    const options = {
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    if (form && submitBtn) {
        form.addEventListener('submit', async (e) => {
            ...
            submitBtn.textContent = "Processing Staffing Request...";
